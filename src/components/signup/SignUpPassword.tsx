      ...
      <div className="w-full mb-15">
        <div className="mb-15">
          ...
          >
            <svg
              className={`shrink-0 ${
                passwordFocus ? "fill-black" : "fill-(--gray-78)"
              }`}
              width="20"
              height="20"
              viewBox="0 0 20 20"
